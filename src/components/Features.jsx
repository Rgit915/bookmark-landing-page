...
const Features = () => {
  ...
  return (
    <section className="features-container text-center px-4 py-10">
      <h2 className="text-3xl font-medium text-neutral-blue-950 mb-4">
        Features
      </h2>
      ...
      <hr className="mb-4 border-divider-primary-light" />
        ...
        {slides.map((slide, index) => (
          <>
            <button
              ...
              className={`px-4 py-2 border-b-2 w-full font-normal text-[15px] text-center  ${
                activeTab === index
      ...
      <article className="tab-content relative max-w-4xl mx-auto text-center">
        <div className="relative">
          {/* Rectangle background image */}
          <img
            src={blueRectangle}
            alt="Blue rectangle background"
            className="absolute left-0 top-1/2 -translate-y-1/3 -translate-x-1/3 -z-10 w-[577px] h-[203px] rotate-180"
          />
        ...
        <h3 className="text-2xl font-medium mt-16 mb-4">
          {slides[activeTab].content.heading}
        </h3>
        <p className="text-neutral-blue-950/50 text-[15px] text-center mb-6">
